package com.inheritance.polimorphism;// Cat is a Subclass of Animal
...
import com.inheritance.polimorphism.Animal;
...
/*public AnimalExtended(String name, String favFood){
        super.getName(), super.getFavFood();*/
}
